...
def make_teleoperator_from_config(config: TeleoperatorConfig) -> "Teleoperator":
    ...
    elif config.type == "pico_nero_teleop":
        from .pico_nero_teleop import PicoNeroTeleop

        return PicoNeroTeleop(config)
    elif config.type == "bi_pico_nero_teleop":
        from .bi_pico_nero_teleop import BiPicoNeroTeleop

        return BiPicoNeroTeleop(config)
    else:
        try:
