...
contract_validation() {
  ...
  LEROBOT_CONDA_ENV="${CONDA_ENV}" \
    plans/timer_pipeline/validate_subtask_time_milestone_4.sh contract
...
data_validation() {
  LEROBOT_CONDA_ENV="${CONDA_ENV}" \
    plans/timer_pipeline/validate_subtask_time_milestone_4.sh data
}

regression_validation() {
  LEROBOT_CONDA_ENV="${CONDA_ENV}" \
    plans/timer_pipeline/validate_subtask_time_milestone_4.sh regression
